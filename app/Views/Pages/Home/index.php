        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    ...
                    <a href="#" class="btn btn-outline-success mb-2">Tambah Data</a>
                </div>
                <!-- /.box-header -->
